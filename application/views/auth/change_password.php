    ...
    <div class="row" style="margin-top: 50px;">
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="form-group">
                <label for="<?php echo $new_password['id'] ?>"><?php echo sprintf(lang('change_password_new_password_label'), $min_password_length);?></label>
                 <?php echo form_input($new_password); ?>
            </div> 
                
            <div class="form-group">
                <label for="<?php echo $new_password_confirm['id'] ?>"><?php echo lang('change_password_new_password_confirm_label', 'new_password_confirm');?></label>
